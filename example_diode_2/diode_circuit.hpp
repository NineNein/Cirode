...
namespace diode_circuit
{
    ...
    public:
        ...
        Quantities _quantities(
            ...
            quants.V_2 = x[0];
            quants.V_3 = x[1];
            quants.V_4 = -ctrl_sources.D1_ctrl_cs*this->components.RSD1 + sources.V1;
            quants.V_5 = -ctrl_sources.D2_ctrl_cs*this->components.RSD2 + x[0];
            quants.I_V1 = ctrl_sources.D1_ctrl_cs;
            quants.I_RSD1 = -ctrl_sources.D1_ctrl_cs;
            quants.I_C2 = ctrl_sources.D1_ctrl_cs - ctrl_sources.D2_ctrl_cs - x[0]/this->components.R2;
            quants.I_R2 = x[0]/this->components.R2;
            quants.I_R1 = x[1]/this->components.R1;
            quants.I_C1 = ctrl_sources.D2_ctrl_cs - x[1]/this->components.R1;
            quants.I_RSD2 = -ctrl_sources.D2_ctrl_cs;
        ...
        void operator() ( const state_type &x , state_type &dxdt , const double t , const Sources sources )
        {
            ...
            dxdt[0]=ctrl_sources.D1_ctrl_cs/this->components.C2 - ctrl_sources.D2_ctrl_cs/this->components.C2 - x[0]/(this->components.C2*this->components.R2);
            dxdt[1]=ctrl_sources.D2_ctrl_cs/this->components.C1 - x[1]/(this->components.C1*this->components.R1);
    ...
    int root_finding(const gsl_vector * xs, void *params, gsl_vector * f){
        ...
        double Icalc_0 = 1e-15*(exp((quants.V_4-quants.V_2)/(0.025875)) - 1);
        gsl_vector_set (f, 0, I_0-Icalc_0);
        double I_1     = gsl_vector_get(xs, 1);
        double Icalc_1 = 1e-15*(exp((quants.V_5-quants.V_3)/(0.025875)) - 1);
