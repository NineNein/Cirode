...
#https://sourceforge.net/p/ngspice/discussion/133842/thread/4015c873/
...
VBC = npn_bjt.V("C'")-npn_bjt.V("B'")
VBE = npn_bjt.V("E'")-npn_bjt.V("B'")

q1 = 1.0/(1.0 - VBC/nbm.VAF - VBE/nbm.VAR)

q2 = expr_ibe1/nbm.IKF + expr_ibc1/nbm.IKR

qb = q1/2.0 * (1.0+(1+4.0*q2)**nbm.NKF)
